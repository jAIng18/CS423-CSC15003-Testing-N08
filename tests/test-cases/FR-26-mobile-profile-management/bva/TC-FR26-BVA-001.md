# TC-FR26-BVA-001: Từ chối cập nhật hồ sơ khi số điện thoại có 9 chữ số
...
|---|---|---:|---|---|---|
| COND-FR26-BVA-001 | `091234567` | 9 chữ số | Lower OFF⁻ / BV-PHONE-001 | Đã đăng nhập; đúng chủ sở hữu; Họ Tên và Địa chỉ hợp lệ danh nghĩa; Email read-only; không đổi `role` | Từ chối cập nhật, hiển thị lỗi số điện thoại không hợp lệ, hồ sơ không thay đổi |

> **Ghi chú:** Chuỗi `091234567` có đúng 9 chữ số, bắt đầu bằng `0` và chỉ gồm chữ số. Test case isolate lỗi độ dài ngay dưới minimum boundary.
...
3. Nhập Số điện thoại là `091234567`.
4. Lưu cập nhật hồ sơ.
5. Quan sát thông báo lỗi và kiểm tra dữ liệu hồ sơ sau thao tác.

## Expected result
Hệ thống từ chối cập nhật vì số điện thoại có 9 chữ số, thấp hơn minimum boundary 10 chữ số. Giao diện mobile hiển thị rõ lỗi về số điện thoại không hợp lệ và dữ liệu hồ sơ đã lưu trước đó không bị thay đổi.
