# TC-FR26-DT-004: Từ chối cập nhật hồ sơ khi số điện thoại ít hơn 10 chữ số
...
| Số điện thoại | Text | Invalid nếu ít hơn 10 chữ số |
...
|---|---|---|---|---|---|
| COND-FR26-DT-004 | EC-AUTH-V01, EC-OWNER-V01 | EC-NAME-V01 | EC-PHONE-I02: `091234567` | EC-EMAIL-V01, EC-ROLE-V01 | Từ chối cập nhật, hiển thị lỗi số điện thoại không hợp lệ, dữ liệu không thay đổi |
...
## Expected result
Hệ thống từ chối cập nhật vì số điện thoại có ít hơn 10 chữ số, hiển thị rõ lỗi về số điện thoại không hợp lệ, và dữ liệu hồ sơ đã lưu trước đó không bị thay đổi.
