# TC-FR26-BVA-003: Cập nhật hồ sơ thành công khi số điện thoại có 11 chữ số
...
|---|---|---:|---|---|---|
| COND-FR26-BVA-003 | `09123456789` | 11 chữ số | Lower OFF⁺ / Upper ON / BV-PHONE-003 | Đã đăng nhập; đúng chủ sở hữu; Họ Tên và Địa chỉ hợp lệ danh nghĩa; Email read-only; không đổi `role` | Chấp nhận cập nhật, hiển thị thông báo thành công |

> **Ghi chú:** Chuỗi `09123456789` có đúng 11 chữ số, bắt đầu bằng `0` và chỉ gồm chữ số. Đây là ON point của upper boundary.
...
| Độ dài số điện thoại | 11 chữ số |
...
## Expected result
Hệ thống chấp nhận số điện thoại `09123456789` vì có đúng 11 chữ số, cập nhật hồ sơ thành công và hiển thị rõ thông báo thành công. Dữ liệu hồ sơ sau khi lưu hiển thị đúng giá trị đã nhập.
