# TC-FR26-DT-006: Từ chối cập nhật hồ sơ khi số điện thoại chứa ký tự không phải chữ số
...
| Số điện thoại | Text | Invalid nếu chứa ký tự không phải chữ số |
...
|---|---|---|---|---|---|
| COND-FR26-DT-006 | EC-AUTH-V01, EC-OWNER-V01 | EC-NAME-V01 | EC-PHONE-I04: `09123abc78` | EC-EMAIL-V01, EC-ROLE-V01 | Từ chối cập nhật, hiển thị lỗi số điện thoại không hợp lệ, dữ liệu không thay đổi |
...
3. Nhập Số điện thoại là `09123abc78`.
4. Lưu cập nhật hồ sơ.
5. Quan sát thông báo lỗi và kiểm tra dữ liệu hồ sơ sau thao tác.

## Expected result
Hệ thống từ chối cập nhật vì số điện thoại chứa ký tự không phải chữ số, hiển thị rõ lỗi về số điện thoại không hợp lệ, và dữ liệu hồ sơ đã lưu trước đó không bị thay đổi.
